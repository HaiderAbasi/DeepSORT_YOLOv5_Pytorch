...
from traffic_monitoring.color_recognition_module import color_histogram_feature_extraction
from traffic_monitoring.color_recognition_module import knn_classifier
import os
from traffic_monitoring.image_utils import crop_image
...
def color_recognition(crop_img):
    ...
    open(current_path + '/traffic_monitoring/color_recognition_module/' + 'test.data', 'w')
    ...
    prediction = knn_classifier.main(current_path
            + '/traffic_monitoring/color_recognition_module/' + 'training.data',
            current_path + '/traffic_monitoring/color_recognition_module/'
            + 'test.data')
